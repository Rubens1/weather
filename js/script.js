    ...
    navigator.geolocation.getCurrentPosition(
        ...
        error => { // Show alert if user denied the location permission
            if (error.code === error.PERMISSION_DENIED) {
                alert("Solicitação de localização negada. Redefina a permissão de localização para conceder acesso novamente.");
            } else {
                alert("Erro de solicitação de geolocalização. Redefina a permissão de localização.");
            }
        });
}
